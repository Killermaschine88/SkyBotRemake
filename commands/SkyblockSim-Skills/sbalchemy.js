...
module.exports = {
  ...
  async execute(client, message, args, mclient) {
    ...
    await collection.updateOne(
      ...
      { $inc: { money: coins, alchemy: earnedxp } },
      { upsert: true })

    const finished = new Discord.MessageEmbed()
      .setColor('90EE90')
      .setDescription(`Finished brewing Potions and earned <:coins:861974605203636253> ${coins} Coins and <:alchemy:852069714480988180> ${earnedxp} Alchemy XP.`)
