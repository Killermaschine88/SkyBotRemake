        ...
        let msec7 = Math.floor(mtime7 % 60)
             ...
             const foundresult = new Discord.MessageEmbed()  
                ...
                .addFields(
                    ...
                    {name: "<:bonzo:852111493859115019> Floor 1", value: `Completions: **${tier1}**\nFastest S+: **${min1}m ${sec1}s**\nBest Score: **${value1}**`, inline: true},
                    {name: "<:scarff:852111493909446686> Floor 2", value: `Completions: **${tier2}**\nFastest S+: **${min2}m ${sec2}s**\nBest Score: **${value2}**`, inline: true},
                    {name: "<:professor:852111493952176148> Floor 3", value: `Completions: **${tier3}**\nFastest S+: **${min3}m ${sec3}s**\nBest Score: **${value3}**`, inline: true},
                    {name: "<:thorn:852111493990580284> Floor 4", value: `Completions: **${tier4}**\nFastest S+: **${min4}m ${sec4}s**\nBest Score: **${value4}**`, inline: true},
                    {name: "<:livid:852111493784666123> Floor 5", value: `Completions: **${tier5}**\nFastest S+: **${min5}m ${sec5}s**\nBest Score: **${value5}**`, inline: true},
                    {name: "<:sadan:852111495466582017> Floor 6", value: `Completions: **${tier6}**\nFastest S+: **${min6}m ${sec6}s**\nBest Score: **${value6}**`, inline: true},
                    {name: "<:necron:852111495575765012> Floor 7", value: `Completions: **${tier7}**\nFastest S+: **${min7}m ${sec7}s**\nBest Score: **${value7}**`, inline: true},


                    {name: "\u200b", value: "**Master Catacombs**"},


                    {name: "<:bonzo:852111493859115019> Floor 1", value: `Completions: **${mtier1}**\nFastest S+: **${mmin1}m ${msec1}s**\nBest Score: **${mvalue1}**`, inline: true},
                    {name: "<:scarff:852111493909446686> Floor 2", value: `Completions: **${mtier2}**\nFastest S+: **${mmin2}m ${msec2}s**\nBest Score: **${mvalue2}**`, inline: true},
                    {name: "<:professor:852111493952176148> Floor 3", value: `Completions: **${mtier3}**\nFastest S+: **${mmin3}m ${msec3}s**\nBest Score: **${mvalue3}**`, inline: true},
                    {name: "<:thorn:852111493990580284> Floor 4", value: `Completions: **${mtier4}**\nFastest S+: **${mmin4}m ${msec4}s**\nBest Score: **${mvalue4}**`, inline: true},
                    {name: "<:livid:852111493784666123> Floor 5", value: `Completions: **${mtier5}**\nFastest S+: **${mmin5}m ${msec5}s**\nBest Score: **${mvalue5}**`, inline: true},
                    {name: "<:sadan:852111495466582017> Floor 6", value: `Completions: **${mtier6}**\nFastest S+: **${mmin6}m ${msec6}s**\nBest Score: **${mvalue6}**`, inline: true},
                    {name: "<:necron:852111495575765012> Floor 7", value: `Completions: **${mtier7}**\nFastest S+: **${mmin7}m ${msec7}s**\nBest Score: **${mvalue7}**`, inline: true},
                )
