        ...
        return message.channel.send({embeds: [
            new Discord.MessageEmbed()  
                ...
                .addFields(
                    ...
                    {name: "<:combat:852069714527911956> Skill Average", value: toFixed(apiData.data.skills.average_skills), inline: true},
                )
        ]})
    },
};
...
async function getApiData(ign) {
    ...
    const response = await fetch(`https://baltraz.repl.co/v1/profiles/${UUID}/skills?key=${config.apikey}`);
