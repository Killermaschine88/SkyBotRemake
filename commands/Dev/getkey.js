  ...
  async execute(client, message, args) {
    ...
    bot.on('message', async message => {
      ...
      if (message.text === 'Your new API key is ') {
        ...
        fs.writeFileSync('/home/runner/SkyBotRemake/config.json', JSON.stringify(old))

        over.mojangClientToken = 'reset'
        fs.writeFileSync('/home/runner/SkyBotRemake/launcher_accounts.json', JSON.stringify(over))
