...
module.exports = {
  ...
  execute: (client, message, args) => {
    if (!message.member.permissions.has('KICK_MEMBERS')) return message.channel.send("You are missing the Permission \`KICK_MEMBERS\`.");
    if (!message.guild.me.permissions.has('KICK_MEMBERS')) return message.channel.send("I don\'t have \`KICK_MEMBERS\` Permission.");
